...
const CategoryProduct = () => {
    ...
    return (
        <div className="container mx-auto flex grid grid-cols-10">
            <div className="col-span-2">
                ...
                <div className="flex gap-5 mt-4">
                    <button className="bg-yellow-900 w-6 rounded-full" onClick={() => setColor('brown')}>.</button>
                    <button className="bg-blue-600 w-6 rounded-full" onClick={() => setColor('blue')}>.</button>
                    <button className="bg-yellow-100 w-6 rounded-full" onClick={() => setColor('beige')}>.</button>
                </div>
                <div className="flex gap-5 mt-4">
                    <button className="bg-red-500 w-6 rounded-full" onClick={() => setColor('red')}>.</button>
                    <button className="bg-green-500 w-6 rounded-full" onClick={() => setColor('green')}>.</button>
                    <button className="bg-gray-900 w-6 rounded-full" onClick={() => setColor('black')}>.</button>
                </div>
                <div className="flex gap-5 mt-4">
                    <button className="bg-gray-400 w-6 rounded-full" onClick={() => setColor('gray')}>.</button>
                    <button className="bg-gray-100 w-6 rounded-full" onClick={() => setColor('white')}>.</button>
                    <button className="bg-pink-400 w-6 rounded-full" onClick={() => setColor('pink')}>.</button>
                </div>
                <div className="flex gap-5 mt-4">
                    <button className="bg-indigo-700 w-6 rounded-full" onClick={() => setColor('purple')}>.</button>
                    <button className="bg-yellow-600 w-6 rounded-full" onClick={() => setColor('orange')}>.</button>
                    <button className="bg-yellow-500 w-6 rounded-full" onClick={() => setColor('yellow')}>.</button>
                </div>
